...
export const M913_PID = 0xfa07;        // 2.4G wireless receiver (dongle)
export const M913_PID_WIRED = 0xfa08;  // wired / dual-mode USB
export const M913_PIDS = [M913_PID, M913_PID_WIRED];
